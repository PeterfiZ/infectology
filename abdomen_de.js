    ...
    diseases: [
      {
        ...
        clinical: {
          ...
          onset: 'Akut',
          symptoms: [
            { name: 'Wässrige Diarrhoe', description: 'Anfänglich wässriger, dann charakteristisch grünlicher, übelriechender ("Pferdestall-Geruch") Durchfall (3-15x/Tag). Bei pseudomembranöser Kolitis schwere Unterbauchschmerzen und Leukozytose. Komplikation: toxisches Megakolon.', severity: 'severe' },
      ...
      },
      {
        ...
        clinical: {
          ...
          onset: 'Plötzlich',
          symptoms: [
            { name: 'Diarrhoe', description: 'Plötzlich einsetzender, reichlicher, wässriger, manchmal schleimiger oder blutiger Durchfall. Gekennzeichnet durch Übelkeit, Erbrechen und diffuse Bauchschmerzen.', severity: 'moderate' },
      ...
      },
      {
        ...
        clinical: {
          ...
          onset: 'Plötzlich',
          symptoms: [
            { name: 'Dysenterie', description: 'Anfänglich wässriger Durchfall, gefolgt von klassischer Dysenterie: häufige, kleinvolumige blutig-schleimige ("sputumartige") Stühle.', severity: 'severe' },
      ...
      },
      {
        ...
        clinical: {
          ...
          symptoms: [
            ...
            { name: 'Blutige Diarrhoe (EHEC/EIEC)', description: 'Bei EHEC plötzlich einsetzender wässriger, dann massiv blutiger Durchfall (hämorrhagische Kolitis) OHNE Fieber. Ausgeprägte Bauchkrämpfe. Komplikation: HUS.', severity: 'severe' }
          ],
