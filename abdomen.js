    ...
    diseases: [
      {
        ...
        diagnostics: {
          ...
          imaging: [
            { modality: 'CT has', finding: 'Szabad levegő a hasüregben, folyadékgyülem, tályog', significance: 'Aranymérce a perforáció helyének keresésében' },
      ...
      },
      {
        ...
        diagnostics: {
          ...
          imaging: [
            { modality: 'Has UH', finding: 'Megvastagodott epehólyag fal (>3 mm), pericholecystás folyadék, kő, pozitív ultrahangos Murphy-jel', significance: 'Aranymérce, legérzékenyebb és legspecifikusabb' },
      ...
      },
      {
        ...
        diagnostics: {
          ...
          imaging: [
            { modality: 'CT has (kontrasztos)', finding: 'Vastagbélfal megvastagodás (>4 mm), perikolikus zsír beszűrődése, esetleg tályog vagy szabad levegő', significance: 'Aranymérce, osztályozás (Hinchey)' },
